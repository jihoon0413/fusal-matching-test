...
import yesshower from '../img/Group 105.png'
import noshower from '../img/Group 107.png'

const InfoList = ({id,price,name,address,time,phone,images,norest,parking,shower}) => {
      ...
      <div className='card'>
        ...
        <div className='description'>
            <div className='head'>
              ...
              <div className='price'>2시간 ￦{Number(price).toLocaleString()}</div>
