...
const Field = ({field, endTime, startTime, date,fetchField}) => {
  ...
  return (
    <div className='field'>
      ...
      {(modalState)
      ?
      <><Modal fetchField={fetchField} field={field} setModalState={setModalState} reserveSort={reserveSort} fieldName={field.fieldNum} date={date} startTime={startTime} endTime={endTime}/>
